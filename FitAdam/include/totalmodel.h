...
struct TotalModel 
{
	...
	Eigen::Matrix<double, Eigen::Dynamic, 3> m_colors;
	...
	Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> m_blendW;
	...
	Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> smpl_pose_prior_A;
	Eigen::VectorXd smpl_pose_prior_mu;
	Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> hand_pose_prior_A;
	Eigen::VectorXd hand_pose_prior_mu;

	const std::array<int, 20> h36m_jointConst_smcIdx{{ 14, 13, 12, 6, 7, 8, 11, 10, 9, 3, 4, 5, 0, 19, 1, 15, 17, 16, 18, 2  }};
	const std::array<int, 20> coco_jointConst_smcIdx{{ 14, 13, 12, 6, 7, 8, 11, 10, 9, 3, 4, 5, 0, 19, 1, 15, 17, 16, 18, 20 }};
